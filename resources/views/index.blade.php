    ...
    <div class="row">
           <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
            ...
            <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
             ...
             <a href="#"><img alt="" src="{{asset('assets/frontend/images/banners/banner-side.png')}}"></a>
             </div>
    </div><!-- /.row -->
</div><!-- /.yamm-content -->					</li>
				</ul>
	...
	<div class="owl-carousel sidebar-carousel custom-carousel owl-theme outer-top-ss">
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="{{asset('assets/frontend/images/hot-deals/p25.jpg')}}" alt="">
							</div>
					...
					<div class="products">
						<div class="hot-deal-wrapper">
							<div class="image">
								<img src="{{asset('assets/frontend/images/hot-deals/p10.jpg')}}" alt="">
							</div>
							<div class="sale-offer-tag"><span>35%<br>off</span></div>
							<div class="timing-wrapper">
								<div class="box-wrapper">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{asset('assets/frontend/images/products/p15.jpg')}}"  alt="">
						</a>					
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img data-echo="{{asset('assets/frontend/images/products/p26.jpg')}}"  alt="">
					</a>					
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{asset('assets/frontend/images/products/p18.jpg')}}" alt="">
					</a>					
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{asset('assets/frontend/images/products/p17.jpg')}}" alt="">
					</a>					
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{asset('assets/frontend/images/products/p16.jpg')}}" alt="">
									</a>					
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img data-echo="{{asset('assets/frontend/images/products/p15.jpg')}}" alt="">
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{asset('assets/frontend/images/products/p14.jpg')}}"  alt="">
						<div class="zoom-overlay"></div>
					</a>					
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{asset('assets/frontend/images/products/p13.jpg')}}" alt="">
					</a>					
				</div><!-- /.image -->
...
<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p30.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p29.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p5.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p6.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p7.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p8.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p9.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p10.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p11.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p12.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p13.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img src="{{asset('assets/frontend/images/products/p14.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p15.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img src="{{asset('assets/frontend/images/products/p16.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img src="{{asset('assets/frontend/images/products/p18.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p17.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
...
<div class="image">
<img class="img-responsive" src="{{asset('assets/frontend/images/banners/home-banner1.jpg')}}" alt="">
</div>
...
<div class="wide-banner cnt-strip">
<div class="image">
<img class="img-responsive" src="{{asset('assets/frontend/images/banners/home-banner2.jpg')}}" alt="">
</div>
...
<section class="section featured-product wow fadeInUp">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/blank.gif')}}" data-echo="{{asset('assets/frontend/images/products/p7.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
...
<div class="wide-banners wow fadeInUp outer-bottom-xs">
	<div class="row">
		...
		<div class="col-md-12">
			<div class="wide-banner cnt-strip">
				<div class="image">
					<img class="img-responsive" src="{{asset('assets/frontend/images/banners/home-banner.jpg')}}" alt="">
				</div>	
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{asset('assets/frontend/images/products/p20.jpg')}}" alt="">
					</a>					
				</div><!-- /.image -->
	...
	<div class="row product-micro-row">
		<div class="col col-xs-5">
			<div class="product-image">
				<div class="image">
					<a href="#">
						<img src="{{asset('assets/frontend/images/products/p21.jpg')}}" alt="">
					</a>					
				</div><!-- /.image -->
		...
		<div class="owl-carousel blog-slider custom-carousel">
				...
				<div class="item">
					<div class="blog-post">
						<div class="blog-post-image">
							<div class="image">
								<a href="blog.html"><img src="{{asset('assets/frontend/images/blog-post/post1.jpg')}}" alt=""></a>
							</div>
						</div><!-- /.blog-post-image -->
				...
				<div class="item">
					<div class="blog-post">
						<div class="blog-post-image">
							<div class="image">
								<a href="blog.html"><img src="{{asset('assets/frontend/images/blog-post/post2.jpg')}}" alt=""></a>
							</div>
						</div><!-- /.blog-post-image -->
...
<section class="section wow fadeInUp new-arriavls">
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p19.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				<a href="detail.html"><img  src="{{asset('assets/frontend/images/products/p28.jpg')}}" alt=""></a>
			</div><!-- /.image -->			
